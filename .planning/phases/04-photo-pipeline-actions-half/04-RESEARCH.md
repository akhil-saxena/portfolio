...
**Confidence:** HIGH on everything measured in this session; MEDIUM on two Cloudflare behaviours that could not be measured without R2 write credentials (flagged inline and in `## Open decisions`)
