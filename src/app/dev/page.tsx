...
const projects = [
  {
    ...
    badges: [
      { label: "Play Store", href: "#", icon: "play-store" as const },
      { label: "GitHub", href: "https://github.com/akhil-saxena/momentum-android", icon: "github" as const },
    ],
  },
  {
    title: "TimeShift",
    ...
    badges: [
      { label: "Chrome Store", href: "#", icon: "chrome-store" as const },
      { label: "GitHub", href: "https://github.com/akhil-saxena/convert-timezone", icon: "github" as const },
    ],
  },
  {
    title: "Steganography",
    ...
    badges: [
      { label: "GitHub", href: "https://github.com/akhil-saxena/Steganography", icon: "github" as const },
    ],
  },
];
